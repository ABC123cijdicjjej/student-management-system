...
-----------------------------------------------------
# Student Management System - Login Page

This repository contains the **Login Page** template (`login.html`) for the Student Management System project.  
It provides a secure interface for users to authenticate before accessing student records.
...
- **Navigation**
  - Link to `register.html` for new users who don’t yet have an account

- **Styling**
  - Integrated with external CSS (`static/style.css`)
  - Clean, minimal design with hover effects and consistent layout
